...
tank1=mpat.Patch(color='#88CCEE',label='R.Tank 1',alpha=1)
tank5=mpat.Patch(color='#228833',label='R.Tank 5',alpha=1)
tank9=mpat.Patch(color='#4477AA',label='R.Tank 9',alpha=1)
tank2=mpat.Patch(color='#DDCC77',label='H.Tank 2',alpha=1)
tank6=mpat.Patch(color='#CC6677',label='H.Tank 6',alpha=1)
tank12=mpat.Patch(color='#882255',label='H.Tank 12',alpha=1)
handles=[tank1,tank5,tank9,tank2,tank6,tank12]#tank2,tank6,tank12]
...
NC_allo_figure(Nb1,Np1,Ne1,Ns1,tank_1_NC,5,'Tank1_NCallo','RE-1')
NC_allo_figure(Nb5,Np5,Ne5,Ns5,tank_5_NC,5,'Tank5_NCallo','RE-5')
NC_allo_figure(Nb9,Np9,Ne9,Ns9,tank_9_NC,4,'Tank9_NCallo','RE-9')
NC_allo_figure(Nb2,Np2,Ne2,Ns2,tank_2_NC,4,'Tank2_NCallo','HE-2')
NC_allo_figure(Nb6,Np6,Ne6,Ns6,tank_6_NC,4,'Tank6_NCallo','HE-6')
NC_allo_figure(Nb12,Np12,Ne12,Ns12,tank_12_NC,5,'Tank12_NCallo','HE-12')
...
PC_allo_figure(Pb1,Pp1,Pe1,Ps1,tank_1_PC,5,'Tank1_PCallo','RE-1')
PC_allo_figure(Pb5,Pp5,Pe5,Ps5,tank_5_PC,5,'Tank5_PCallo','RE-5')
PC_allo_figure(Pb9,Pp9,Pe9,Ps9,tank_9_PC,4,'Tank9_PCallo','RE-9')
PC_allo_figure(Pb2,Pp2,Pe2,Ps2,tank_2_PC,4,'Tank2_PCallo','HE-2')
PC_allo_figure(Pb6,Pp6,Pe6,Ps6,tank_6_PC,4,'Tank6_PCallo','HE-6')
PC_allo_figure(Pb12,Pp12,Pe12,Ps12,tank_12_PC,5,'Tank12_PCallo','HE-12')
